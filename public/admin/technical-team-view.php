...
if (isset($_POST['save_change'])) {
    ...
    $updateCashierQuery = "UPDATE `technical_team` SET 
            ...
            if ($conn->query($updateCashierQuery) === TRUE) {
                ...
                if (!empty($_FILES["nic_image"]["name"]) && $_FILES["nic_image"]["error"] == UPLOAD_ERR_OK) {
                    ...
                    if (move_uploaded_file($_FILES["nic_image"]["tmp_name"], $targetFile)) {
                        header('location: technical-team-view.php?user=' . $lastUserId . '');
                    }
                } else {
                    header('location: technical-team-view.php?user=' . $lastUserId . '');
                }
                            ...
                            <div class="input-content">
                                ...
                                <div class="input-two-content">
                                    <div class="input-two-content-1">
                                        ...
                                        <div class="profile-image">
                                            <div class="profile-image-content-1">
                                                <img src="../assets/images/technical_team/<?php echo $nicImageUrl ?>" alt="" id="preview-image-2">
                                                <input type="file" id="file-input-2" name="nic_image" value="../assets/images/technical_team/<?php echo $nicImageUrl ?>">
