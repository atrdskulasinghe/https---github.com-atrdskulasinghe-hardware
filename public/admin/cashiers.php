        ...
        <section class="active section">
            <div class="content">
                ...
                <div class="technician">
                    <form class="search-2" method="GET" action="./cashiers.php">
                        <div class="search-content-1">
                            <select name="type" id="">
                                <option value="user_id" <?php if (isset($_GET['type']) && $_GET['type'] == 'user_id') echo 'selected'; ?>>By User ID</option>
                                <option value="cashier_id" <?php if (isset($_GET['type']) && $_GET['type'] == 'cashier_id') echo 'selected'; ?>>By Cashier ID</option>
                        ...
                        <div class="card-list">
                            ...
                            if (isset($_GET['type']) && isset($_GET['search'])) {
                                ...
                                if ($searchType == "user_id") {
                                    ...
                                    $selectCashierQuery = "SELECT * FROM `user` WHERE `account_type` = 'cashier' AND `user_id` = '$searchValue'";
                                    ...
                                    if ($result && $result->num_rows > 0) {
                                        ...
                                        <a href="./cashier-view.php?user=' . $user_id . '" class="card">
                                            <div class="technician-image">
                                                <img src="../assets/images/cashiers/' . $profile_url . '" alt="">
                                            </div>
                                    ...
                                    $selectCashierQuery1 = "SELECT * FROM `cashier` WHERE `cashier_id` = '$searchValue'";
                                    ...
                                    $selectCashierQuery = "SELECT * FROM `user` WHERE `account_type` = 'cashier' AND `user_id` = '$user_id'";
                                    $result = $conn->query($selectCashierQuery);
                                    ...
                                    $selectCashierQuery = "SELECT * FROM `user` WHERE `account_type` = 'cashier' AND (`first_name` LIKE '%$searchValue%' OR `last_name` LIKE '%$searchValue%')";
                                    $result = $conn->query($selectCashierQuery);
                                ...
                                $selectCashierQuery = "SELECT * FROM `user` WHERE `account_type` = 'cashier'";
                                $result = $conn->query($selectCashierQuery);
